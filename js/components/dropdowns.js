...
const dropdownIngredientUlElt = document.querySelector(".ingredient .dropdown-ul");
const dropdownIngredientElt = document.querySelector(".ingredient .dropdown-wrapper");
const chevronsIngredientElt = document.querySelector(".ingredient .chevrons");
const filterIngredientLabelElt = document.querySelector(".ingredient .dropdown-label");
const searchIngredientElt = document.querySelector(".ingredient .search");
const chevronUpIngredientElt = document.querySelector(".ingredient .bi-chevron-up");
const chevronDownIngredientElt = document.querySelector(".ingredient .bi-chevron-down");

// appliance filter elements
const dropdownApplianceUlElt = document.querySelector(".appliance .dropdown-ul");
const dropdownApplianceElt = document.querySelector(".appliance .dropdown-wrapper");
const chevronsApplianceElt = document.querySelector(".appliance .chevrons");
const filterApplianceLabelElt = document.querySelector(".appliance .dropdown-label");
const searchApplianceElt = document.querySelector(".appliance .search");
const chevronUpApplianceElt = document.querySelector(".appliance .bi-chevron-up");
const chevronDownApplianceElt = document.querySelector(".appliance .bi-chevron-down");
...
const filterUtensilLabelElt = document.querySelector(".utensil .dropdown-label");
...
const chevronDownUtensilElt = document.querySelector(".utensil .bi-chevron-down");
